...
//echo $firstnam;
$query = "INSERT INTO `tblusers`(`fName`, `lName`, `emailId`, `password`, `otpVerified`, `otpval`, `imei`, `push_id`, `device_id`, `mobile`, `dob`, `college_name`, `address`, `city`, `country`) VALUES ('$fName', '$lastname', '$emailId', MD5('$password'),'no','$otp', '$iemi_no', '$push_id','$device_id','$mobilenumber', '3453534', 'sdfafasf', 'sdvsf', 'sdfsf', 'sdfsfs');";
$result=mysqli_query($con,$query); 
	  if($query){
		$querydata = "SELECT * FROM tblusers order by id desc";  
